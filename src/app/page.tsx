    ...
    <>
      <MaxWidthWrapper className="mb-12 mt-12 sm:mt-40 flex flex-col items-center justify-center text-center">
        ...
        <h1 className="max-w-4xl text-5xl font-bold md:text-6xl lg:text-7xl">
          find any <span className=" text-blue-600">Quote</span> or{' '}
          <span className=" text-blue-600">Book Section</span> in seconds.
        </h1>
            ...
            <div className="mx-auto max-w-6xl px-6 lg:px-8">
              <div className="mt-16 flow-root sm:mt-24">
                <div className="-m-2 rounded-xl bg-gray-900/5 p-2 ring-1 ring-inset ring-gray-900/10 lg:-m-4 lg:rounded-2xl lg:p-4">
                  <Image
                    src="/dashboard-preview.jpg" // TODO: replace with actual image
                    alt="product preview"
                    width={1364}
                    height={866}
                    quality={100}
